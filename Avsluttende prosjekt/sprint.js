      ...
      if (!card.classList.contains("matched")) {
        ...
        if (!firstCard) {
          ...
          if (firstCardValue == secondCardValue) {
            ...
            //gjør at det "første kortet blir false" slik at det neste kortet som velges blir sammenliknet
            firstCard = false;
            //Antall riktige øker 
            winCount += 1;
            ...
            if (movesCount == Math.floor(cardValues.length / 2)) {
              if (winCount <= localStorage.trekk){
